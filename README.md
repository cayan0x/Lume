...
*微光的人设菜单：内置角色卡、蒸馏、管理，入口都在这里*

</div>

---

微光包含两套**相互独立**的能力，装上即全部生效：

1. **思维逻辑引擎** —— P0-P3 四层推理框架，始终注入每个会话，与是否使用人设无关
2. **人设系统** —— 人设是独立的「人」：有自己的名字、自己的记忆，性格会随对话进化；可以纯对话创建，也可以从一段小说/剧本**蒸馏**而成

人设只影响自然语言的语气，永远不碰思维逻辑、代码、命令与工具调用的正确性。
