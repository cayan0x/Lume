...
function MemoryStarMap({ open, onClose, personaName, personaLabel, t, callRpc }) {
	...
	(0, react.useEffect)(() => {
		...
		const nodes = memories.map((m, id) => {
			const x = W / 2 + (Math.random() - .5) * W * .2;
			const y = H / 2 + (Math.random() - .5) * H * .2;
			return {
				id,
				text: m.text,
				at: m.at,
		...
		const forceStep = () => {
			...
			for (const n of nodes) {
				...
				n.vy *= .86;
				if (n.x < 90) n.x = 90;
				else if (n.x > W - 90) n.x = W - 90;
				if (n.y < 90) n.y = 90;
				else if (n.y > H - 90) n.y = H - 90;
			}
		};
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
		open,
		onClose,
		title: `${personaLabel} · ${t("memory.title")}`,
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				}) : memories.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: {
						position: "absolute",
						inset: 0,
						display: "flex",
...
function ManageModal({ open, onClose, onSaved, t, callRpc, items }) {
	...
	const [exporting, setExporting] = (0, react.useState)(null);
				...
				items.map((item) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							exporting === item.name ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
									size: "sm",
									variant: "primary",
									onClick: () => void doExport(item.name),
