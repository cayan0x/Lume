...
function DistillModal({ open, onClose, onSaved, t, callRpc }) {
	...
	const start = async () => {
		...
		try {
			const res = await callRpc("distillStart", {
				...
				profile: profile.gender || profile.ageRange ? profile : void 0
			});
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
		...
		children: [running ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			style: {
				display: "flex",
				alignItems: "center",
				gap: 10,
			...
			children: [
				...
				confirmClose ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: t("distill.close.confirm")
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							gap: 8,
			...
			chatSpeakers && chatSpeakers.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
					style: labelStyle,
					children: t("distill.profile.gender")
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: {
						display: "flex",
					...
					children: [
						...
						"female",
						"other"
					].map((g) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => setProfile((p) => ({
							...p,
							gender: p.gender === g ? void 0 : g
						})),
						style: {
							fontSize: 12,
							padding: "4px 12px",
						...
						children: t(`distill.profile.gender.${g}`)
					}, g))
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
					style: labelStyle,
					children: t("distill.profile.age")
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: {
						display: "flex",
					...
					children: [
						...
						"mid",
						"older"
					].map((a) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => setProfile((p) => ({
							...p,
							ageRange: p.ageRange === a ? void 0 : a
						})),
						style: {
							fontSize: 12,
							padding: "4px 12px",
						...
						children: t(`distill.profile.age.${a}`)
					}, a))
				})
...
const zh = {
	...
	"distill.profile.gender": "TA 的性别（可选，帮助蒸馏更准确）",
	"distill.profile.gender.male": "男",
	"distill.profile.gender.female": "女",
	"distill.profile.gender.other": "其他/不清楚",
	"distill.profile.age": "TA 的年龄段（可选，大概即可）",
	"distill.profile.age.teen": "20 以下",
	"distill.profile.age.young": "20~35",
	"distill.profile.age.mid": "35~50",
	"distill.profile.age.older": "50 以上",
...
const en = {
	...
	"distill.profile.gender": "Their gender (optional, improves the result)",
	"distill.profile.gender.male": "Male",
	"distill.profile.gender.female": "Female",
	"distill.profile.gender.other": "Other / unknown",
	"distill.profile.age": "Their age range (optional, roughly is fine)",
	"distill.profile.age.teen": "Under 20",
	"distill.profile.age.young": "20–35",
	"distill.profile.age.mid": "35–50",
	"distill.profile.age.older": "Over 50",
