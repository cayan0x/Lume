    ...
    return async (endpoint, payload) => {
        ...
        switch (endpoint) {
            ...
            case "distillStart": {
                ...
                const p = typeof rawProfile === "object" && rawProfile !== null ? rawProfile : undefined;
                const profile = p && (typeof p.gender === "string" && p.gender || typeof p.ageRange === "string" && p.ageRange)
