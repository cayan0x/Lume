...
function applyInner(ctx, config = {}) {
    ...
    const { projectKeyFor, commandSummary, flushPendingFacts, settleVerification, saveSessionMemory, taskMemoriesOf, contractOf, changesOf, hypothesesOf, factsOf, requirementsOf, designOf, needsDesignPass, structureToolName, } = projectAccess;
    ...
    const wiring = {
        ...
        probeCaps: (context) => probeDocumentCapabilities(structureToolName(context), context),
    ...
    const blockDeps = assembleBlockDeps(wiring);
