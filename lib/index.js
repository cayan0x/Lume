...
function applyInner(ctx, config = {}) {
    ...
    const { projectKeyFor, commandSummary, flushPendingFacts, settleVerification, contractOf, changesOf, hypothesesOf, factsOf, requirementsOf, designOf, needsDesignPass, structureToolName, } = projectAccess;
