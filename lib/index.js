...
const SWITCH_BOUNDARY_TEXT = "【人设切换】此前对话中助手的语气属于旧人设，一律不再延续、不要模仿；从本条回复起，严格按当前人设的风格契约说话（若当前为默认风格，则用你的默认风格）。";
/** Cordis 插件名 */
...
export function apply(ctx, config = {}) {
    ...
    const boundaryRemainder = new Map();
    function buildSessionText(sessionId) {
        ...
        const persona = personaName ? personalities[personaName] : undefined;
